    ...
    <div className="px-x-default py-y-double-default gap-x-x-default gap-y-default grid md:grid-cols-2 md:grid-rows-2 md:gap-y-0">
      <div>
        <h1 ref={titleRef} className="uppercase">
          {isFrench ? (
            <>
              Un <span className="text-[#ed356d]">projet</span> ou une{' '}
              <span className="text-[#ed356d]">question</span> ?
            </>
          ) : (
            <>
              A <span className="text-[#ed356d]">project</span> or a{' '}
              <span className="text-[#ed356d]">question</span>?
            </>
          )}
        </h1>
        <h3 ref={descriptionRef} className="p2 pt-6">
          {isFrench ? (
            ...
            <>
              ...
              <span className="text-[#ed356d]">We’ll get back to you within 48 hours</span> to move
              forward together.
            </>
          )}
        </h3>
