...
import { portfolio } from '@/constants/offer.constant';
...
const Portfolio = () => {
  ...
  const revealAnimation = contextSafe(() => {
    ...
    if (isTablet) {
      timeline.to(
        [
          `#offer-card-${portfolio[0].type}`,
          `#offer-card-${portfolio[1].type}`,
          `#offer-card-${portfolio[2].type}`,
        ],
        {
          opacity: 1,
          y: 0,
    ...
    timeline
      .to(
        [`#offer-card-${portfolio[0].type}`, `#offer-card-${portfolio[2].type}`],
        {
          x: 0,
          opacity: 1,
          stagger: 0.1,
