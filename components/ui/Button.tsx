      ...
      return (
        <>
          <DynamicElement
            ref={ref}
            className={clsx(
              'label relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 focus:outline-none',
              disabled ? 'cursor-default! opacity-70' : 'cursor-pointer',
              className,
            )}
            {...props}
        ...
        >
          <div
            ...
            className={clsx(
              ...
              color === 'primary' ? 'bg-[#ed356d]' : 'bg-black',
              color === 'primary' && isDark && 'bg-[#ed356d]',
            )}
          />
          <div
            ref={buttonRef}
