...
export default function LetsTalk() {
  return (
    <div className="bg-black pt-[120px] pb-[120px] z-10 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="w-full">
          <div className="relative flex flex-col items-start justify-start">
            <div className="mb-12">
              <h4 className="text-6xl md:text-7xl lg:text-9xl font-bold leading-tight">
            ...
            <div className="inline-block">
              <Link 
                ...
                href="/contact"
              >
                <span className="relative flex items-center gap-3 px-8 py-4 rounded-full font-semibold text-sm md:text-base z-20 animate-bounce-color">
                  Get In Touch
                  <svg
                    width="16"
                    height="17"
                ...
                <svg
                  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[160px] h-[160px] -z-10 animate-spin-slow opacity-30"
                  width="160"
                  height="161"
                  viewBox="0 0 160 161"
                  fill="none"
            ...
            <div className="absolute top-0 right-0 w-48 h-48 md:w-64 md:h-64 opacity-20">
              <Image src={cta} alt="cta-img" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </div>
