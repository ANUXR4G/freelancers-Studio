...
const CardFaq = ({
  ...
  return (
    <div
      ref={cardRef}
      className={clsx(
        'flex cursor-pointer flex-col gap-6 rounded-3xl p-6 backdrop-blur-xl transition-all duration-300 hover:scale-95 hover:bg-[#ed356d]/40',
        isActive ? 'bg-[#ed356d]/30' : 'bg-[#ed356d]/15',
        className,
      )}
      onClick={onToggle}
