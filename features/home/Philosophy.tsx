        ...
        >
          {isFrench ? (
            <>
              ...
              <span> et </span>
              <span className="text-[#ed356d]">performantes</span>
              <span>.</span>
            </>
          ) : (
            <>
              ...
              <span> and </span>
              <span className="text-[#ed356d]">high-performance</span>
        ...
        >
          {isFrench ? (
            <>
              ...
              <span className="text-[#ed356d]">esthétique</span>
              <span> et l'</span>
              <span className="text-[#ed356d]">accessibilité</span>
              <span>, nous imaginons des interfaces </span>
              <span className="text-[#ed356d]">fluides</span>
              <span> et </span>
              <span className="text-[#ed356d]">innovantes</span>
              <span>, pensées pour </span>
              <span className="text-[#ed356d]">évoluer</span>
              <span> avec les besoins de </span>
              <span className="text-[#ed356d]">demain</span>
              <span>.</span>
            </>
          ) : (
            <>
              ...
              <span className="text-[#ed356d]">evolve</span>
