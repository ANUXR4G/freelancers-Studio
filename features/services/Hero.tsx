...
const Hero = () => {
  ...
  return (
    ...
    >
      <FloatingHalo
        className="pointer-events-none absolute top-0 -left-1/3 -z-10 h-[200vw] w-[200vw] opacity-40"
        from="#ed356d"
        to="#f1f2ff00"
      />
          ...
          <h2 ref={titleRef} className="relative w-[60vw] md:w-[50vw]">
            ...
            {isFrench ? (
              ...
              <>
                ...
                <span> and </span>
                <span className="text-[#ed356d]">performant</span>
                <span>.</span>
              </>
            )}
          </h2>
          ...
          >
            ...
            {isFrench ? (
              ...
              <>
                ...
                <span className="text-[#ed356d]">innovative</span>
